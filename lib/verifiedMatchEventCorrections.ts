...
const VERIFIED_GOAL_CORRECTIONS: Record<string, VerifiedGoalCorrection> = {
  ...
  "czechia-vs-south-africa-jun18": {
    note: "Verified score/event completion: 54' Michal Sadilek for Czechia; 83' Teboho Mokoena penalty for South Africa. Corrections per Guardian live report and provider score 1-1.",
    events: [
      {
        type: "PENALTY_GOAL",
        minute: 54,
  ...
  "switzerland-vs-bosnia-jun18": {
    note: "Verified score/event completion: Switzerland 4-1 Bosnia & Herzegovina, including 90+6' Granit Xhaka penalty. Corrections per Guardian live report and provider score 4-1.",
    events: [
      {
        type: "GOAL",
        minute: 17,
  ...
  "austria-vs-jordan-jun16": {
    note: "Verified score/event completion: 10' Marko Arnautovic, 34' Christoph Baumgartner, 76' Yazan Al-Arab own goal benefiting Austria, 87' Ali Olwan for Jordan. Corrections per Guardian live report and provider score 3-1.",
    events: [
      {
        type: "GOAL",
        minute: 10,
