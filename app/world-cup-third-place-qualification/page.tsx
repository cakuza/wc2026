    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="mb-1 font-heading text-2xl font-extrabold uppercase tracking-wide text-ink">
            Final third-place ranking
          </h2>
        ...
        <section className="mt-6">
          <h2 className="mb-2 font-heading text-xl font-extrabold uppercase tracking-wide text-ink">
