...
export function TeamCard({ team }: { team: Team }) {
  ...
  return (
    <Link
      ...
      prefetch={false}
      className="group flex flex-col rounded-xl border border-line bg-surface p-4 transition hover:border-accent/60 hover:shadow-xl"
    >
      ...
      <div className="mt-3 rounded-lg border border-line bg-canvas p-3">
        <p className="text-[11px] font-bold uppercase tracking-wider text-faint">{t("lbl_firstMatch")}</p>
