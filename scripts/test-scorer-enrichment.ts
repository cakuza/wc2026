...
async function runSharedMapTests() {
  ...
  try {
    ...
    const worldcupGames: any[] = [
      { providerGameId: "1", homeTeamName: "Mexico", awayTeamName: "South Africa", homeScore: 2, awayScore: 0, finished: true,
      ...
      { providerGameId: "2", homeTeamName: "South Korea", awayTeamName: "Czech Republic", homeScore: 2, awayScore: 1, finished: true,
      ...
      { providerGameId: "537333", homeTeamName: "Canada", awayTeamName: "Bosnia & Herzegovina", homeScore: 1, awayScore: 1, finished: true,
      ...
      { providerGameId: "537334", homeTeamName: "United States", awayTeamName: "Paraguay", homeScore: 4, awayScore: 1, finished: true,
